...
eso_generator = [
    data_dict[x]["exercised_stock_options"] for x in data_dict
    if data_dict[x]["exercised_stock_options"] != "NaN"
]
eso_max_value = max(eso_generator)
eso_min_value = min(eso_generator)
print("Maximum eso: {}, minimum eso: {}".format(eso_max_value, eso_min_value))

salary_generator = [
    data_dict[x]["salary"] for x in data_dict
    if data_dict[x]["salary"] != "NaN"
]
salary_max_value = max(salary_generator)
salary_min_value = min(salary_generator)
print("Maximum salary: {}, minimum salary: {}".format(
    salary_max_value, salary_min_value))
